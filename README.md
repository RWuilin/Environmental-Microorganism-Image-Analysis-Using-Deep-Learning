...
```
environment_microorganism/
│
├── task 1 - Image denoising/          # Image denoising task
│   ├── DnCNN.ipynb                   # DnCNN model implementation
│   ├── SPN+TROF.ipynb                # SPN+TROF model implementation
│   ├── EMDS5-Denoised-Trof/          # SPN+TROF denoising results
│   └── EMDS5-Denoised-DnCnn/         # DnCNN denoising results
│
├── task 2 - Image segmentation/       # Image segmentation task
│   ├── U-net/                        # U-Net implementation
│   │   ├── EMDS5-Unet-Trof.ipynb    # U-Net implementation based on TROF denoising
│   │   ├── EMDS5-Unet-Original.ipynb # U-Net implementation based on original images
│   │   ├── EMDS5-Unet-DnCnn.ipynb   # U-Net implementation based on DnCNN denoising
│   │   ├── model-spn.pth            # SPN model weights
│   │   ├── model-denoised.pth       # Denoised model weights
│   │   ├── model-original.pth       # Original model weights
│   │   └── SegmentedImages/         # Segmentation results directory
│   │
│   ├── U-Net++/                      # U-Net++ implementation
│   │   ├── U-net++.ipynb            # U-Net++ model implementation
│   │   ├── unetpp_model.pth         # U-Net++ model weights
│   │   ├── EMDS5-Unetpp-Trof/       # Segmentation results after TROF denoising
│   │   └── EMDS5-Unetpp-DnCnn/      # Segmentation results after DnCNN denoising
│   │
│   └── DeepLabV3Plus_ResNet/         # DeepLabV3Plus implementation
│       ├── DeepLabV3Plus_ResNet.ipynb # DeepLabV3Plus model implementation
│       ├── segmentation_deeplabv3plus_resnet101.pth # ResNet101 model weights
│       └── segmentation_deeplabv3plus_resnet50.pth  # ResNet50 model weights
│
├── task 3 - Feature extraction/       # Feature extraction and SVM classifier task
│   ├── LBP_SVM/                          # LBP feature extraction and SVM classifier
│   │   ├── LBP_SVM.ipynb                # LBP feature extraction algorithm
│   │   └── lbp_block_features.csv   # Extracted LBP features
│   │
│   └── RGB_HSV_SVM/                          # RGB or HSV feature extraction and SVM classifier task
│       ├── RGB_HSV_SVM.ipynb                # RGB or HSV feature extraction and SVM classifier 
│       ├── masked_color_features_Denoised.csv  # Color features after denoising
│       ├── masked_hsv_features_Denoised.csv    # HSV features after denoising
│       ├── color_hist_confusion_matrix.png     # RGB color histogram confusion matrix
│       ├── hsv_confusion_matrix.png           # HSV space confusion matrix
│       ├── hsv_svm.png                       # HSV-SVM classification visualization
│       └── RGB_svm.png                       # RGB-SVM classification visualization
│
├── task 4 - Image classification/     # Image classification task
│   ├── ResNet18&50, EfficientB0, Vit, ViT+Attention/  # Main classification models
│   │   ├── above_80/                # Models with accuracy above 80%
│   │   │   ├── 85_classification_resnet18.ipynb
│   │   │   ├── 82_classification_ResNet50.ipynb
│   │   │   └── 80_classification_efficientB0.ipynb
│   │   └── under_80/                # Models with accuracy under 80%
│   │       ├── 27_classification_Vit_attention.ipynb
│   │       └── 50_classification_simpleVit.ipynb
│   │
│   └── Xception, ResNet-34, DenseNet-169, InceptionResNetV1, DeiT Classifiers/
│       └── Classifiers.ipynb        # Implementation of additional classifiers
│
├── task 5 - Object Detection/         # Object detection task
│   └── Faster_RCNN/                  # Faster R-CNN implementation
│       ├── Faster_RCNN.ipynb        # Faster R-CNN model implementation
│       ├── detection_results/       # Detection results output
│       │   ├── visualizations/     # Detection result visualization
│       │   └── metrics/           # Detection performance metrics
│       └── model_weights/          # Model weights storage
│           ├── backbone/          # Backbone network weights
│           └── detector/          # Detector weights
│
└── EMDS-6/                           # Dataset
    ├── EMDS5-Original/               # Original images
    └── EMDS5-Ground Truth/           # Ground truth images
```
